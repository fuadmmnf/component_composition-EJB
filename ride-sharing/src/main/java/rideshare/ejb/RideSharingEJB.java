...
public class RideSharingEJB { // sequential component composition
    ...
    public void operateRideShare() { //ideally various data regarding the ride is passed as parameter, incompatibility in operation or parameter would require glue code
